...
if (!number(0,10)) {
        switch(number(1,4)) {
                ...
                case 2: do_say(ch, "Got them locked in my pen, never bother me again.",0);
                        break;
                case 3: do_say(ch, "The Mayor of Alma Civitas can't see what is happening to his own town!",0);
                        break;
...
if (!number(0,70)) {
        switch(number(1,4)) {
                ...
                case 3:do_shout(ch,"Anyone seen that scribe?",0);
                        break;
                case 4:do_shout(ch,"Benem will help me rid Lumen et Umbra of the invaders!",0);
                        break;
                default:
                        break;
