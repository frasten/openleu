...
#define LIM_ITEM_COST_MIN 15000     /* mininum rent cost of a lim. item 
...
struct obj_data
{
  ...
  long char_vnum;                /* for ressurection     */
#if defined( EMANUELE )
  char oldfilename[ 20 ];
#else
...
struct char_player_data
{
  ...
  byte level[ABS_MAX_CLASS];      /* NEEDS TO BE ABS_MAX_CLASS */ 
                        /* PC / NPC s level         */
